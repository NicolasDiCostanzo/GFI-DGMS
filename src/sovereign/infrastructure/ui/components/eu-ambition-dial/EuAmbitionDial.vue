...
import { EU_AMBITION_SCENARIOS } from '@/sovereign/infrastructure/ui/constants/EuAmbitionScenarios';
import { calculateEuFundingTodayUsd } from '@/sovereign/infrastructure/ui/utils/calculateEuFundingToday';
